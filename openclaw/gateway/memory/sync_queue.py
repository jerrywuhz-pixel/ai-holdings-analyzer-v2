...
class SyncQueue:
    ...
    def __init__(
        ...
        self._queue: asyncio.Queue[WriteSignal] = asyncio.Queue()
        self._consumer_task: asyncio.Task | None = None
        self._running = False

    async def enqueue(self, signal: WriteSignal) -> None:
        ...
        if self._consumer_task:
            try:
                ...
                try:
                    ...
                    pass
                logger.warning("[sync_queue] Consumer stopped with pending items")
    ...
    async def _consume_loop(self) -> None:
        poll_interval = min(self._flush_interval, 0.1)
